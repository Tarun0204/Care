...
<body>
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-xs-10 col-md-4 mt-4">
        <div class="card">
          <img src="https://www.carehospitals.com/assets/images/main/dr-a-k-jinsiwale.webp" 
      ...
      <!-- Add more cards here in the same structure -->
    </div>
  </div>
...
<body>
  ...
  <div class="container mt-5">
    ...
    <div class="col-xs-10 col-md-4 mt-4">
        <div class="card">
          <img src="https://www.carehospitals.com/assets/images/main/dr.-(lt-col)-p.-prabhakar.webp" 
            alt="Dr. (Lt Col) P. Prabhakar" class="media-img">
      ...
      <div class="col-xs-10 col-md-4 mt-4">
        <div class="card h-100 mb-3" style="max-width: 540px;">
          <div class="row g-0">
            <div class="col-md-4">
              <img src="https://www.carehospitals.com/assets/images/main/best-pulmonologist-a-jayachandra.webp"
                alt="Trendy Pants and Shoes" class="media-img img-fluid rounded-start topimg mt-3">
            </div>
            <div class="col-md-8">
              <div class="card-body text-center">
                <h5 class="card-title">Dr. A Jayachandra</h5>
                <p class="card-text">Clinical Director
                  Speciality
                  Pulmonology
                  Qualification
                  MBBS, DTCD, FCCP Special training in Med.
                  Hospital
                  CARE Hospitals, Banjara Hills, Hyderabad
                </p>
                <a href="appointment.php"><button class="btn btn-primary">Book an Appointment</button></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card h-100 mb-3" style="max-width: 540px;">
          <div class="row g-0">
            ...
            <div class="col-md-8">
              <div class="card-body text-center">
                <h5 class="card-title">Dr. A K Jinsiwale</h5>
                <p class="card-text">Consultant Orthopedics
                  Speciality
                  Orthopaedics
                  Qualification
    ...
    <div class="row">
      ...
      <div class="col-xs-10 col-md-4 mt-4">
        <div class="card h-100 mb-3" style="max-width: 540px;">
          <div class="row g-0">
            <div class="col-md-4">
              <img src="https://www.carehospitals.com/assets/images/main/dr-a-nagesh.webp" alt="Trendy Pants and Shoes"
                class="media-img img-fluid rounded-start topimg mt-3">
            </div>
            <div class="col-md-8">
              <div class="card-body text-center">
                <h5 class="card-title">Dr. A Nagesh</h5>
                <p class="card-text">Sr. Consultant - Cardio Thoracic & Heart Transplant Surgery
                  Speciality
                  Cardiac Surgery
                  Qualification
                  MBBS, MCh (CTVS)
      ...
      <div class="col-xs-10 col-md-4 mt-4">
        <div class="card h-100 mb-3" style="max-width: 540px;">
          <div class="row g-0">
            <div class="col-md-4">
              <img src="https://www.carehospitals.com/assets/images/main/aem-harika.webp" alt="Trendy Pants and Shoes"
                class="media-img img-fluid rounded-start topimg mt-3">
            </div>
            <div class="col-md-8">
              <div class="card-body text-center">
    ...
    <div class="row mt-4">
      <div class="col-xs-10 col-md-4 mt-4">
        <div class="card h-100 mb-3" style="max-width: 540px;">
          <div class="row g-0">
            <div class="col-md-4">
              <img src="https://www.carehospitals.com/assets/images/main/dr-a-r-vikram-sharma.webp"
                alt="Trendy Pants and Shoes" class="media-img img-fluid rounded-start topimg mt-3">
            </div>
            <div class="col-md-8">
              <div class="card-body text-center">
                <h5 class="card-title">Dr. A R Vikram Sharma</h5>
                <p class="card-text">Jr. Consultant
                  Speciality
                  General Surgery
                  Qualification
                  MBBS, MS
          ...
          <div class="row g-0">
            ...
            <div class="col-md-8">
              <div class="card-body text-center">
                ...
                <p class="card-text">Sr. Consultant Cardiologist
                  Speciality
                  Cardiology
                  Qualification
                  MBBS, MD
          ...
          <div class="row g-0">
            ...
            <div class="col-md-8">
              <div class="card-body text-center">
                ...
                <p class="card-text">Sr. Consultant and Head of the Dept
                  Speciality
